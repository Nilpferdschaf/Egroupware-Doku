...
<body id="top">
	...
	<p>EGroupware is an online open source group collaboration tool whose
		...
		systems and many more. But all that doesn't matter if you require a
	...
	<p>
		In this tutorial you will build a minimal application, the classic <span
			class="app">Hello world</span>. The hardest part will be to get
		Egroupware to recognize our application. To follow this tutorial,
		EGroupware should already be installed. If it isn't, take a look at
		the <a href="https://github.com/EGroupware/egroupware/tree/16.1">EGroupware
			Github page</a> and come back once you're done.
	</p>
	<h3>Writing the application</h3>
	<p>To start off, you need to add some files to the EGroupware
		installation directory. EGroupware will look for these and if it finds
		them, make the application available for installation.</p>
	...
	<p>
		Everything you do from now on will happen within the folder <span
			class="file">helloworld/</span>. This will also be the name of our
		...
		and it will therefore mark the entry point to all other code we write.
		If you know Java or C, you can think of this file as the main()
		function. It should set everything up, but ultimately call some other
		code. That is what <span class="file">inc/</span> is for: It contains
		the entire rest of the codebase.<br> The <span class="file">setup/</span>
		folder contains everything EGW needs to know to install the
		application. For now, the only content will be <span class="file">setup.inc.php</span>.<br>
		Next up, <span class="file">templates/</span> will contain UI
		templates and images used within the application. We won't use this
		until later, so it's empty for now except for some basic structure.<br>
	</p>
...
&lt;/html&gt;</pre>
	...
	<p>
		...
		You will notice the app ist not there yet. Before you can access it,
		it needs to be registered and installed within EGW and made available
		to your account. For the first step, you just need to edit <span
...
$setup_info ['helloworld'] ['depends'] = array(
	...
	<p>
		...
		the admin-tab on the left, secondary click on your account, choose <span
		...
		the page and you should see helloworld in the sidebar. Click on it.
	</p>
